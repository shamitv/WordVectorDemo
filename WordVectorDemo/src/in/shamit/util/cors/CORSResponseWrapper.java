...
public class CORSResponseWrapper extends HttpServletResponseWrapper {
	...
	public CORSResponseWrapper(final HttpServletResponse response) {
		...
		super(response);
		response.setHeader(HeaderName.ACCESS_CONTROL_ALLOW_CREDENTIALS, "true");
		response.setHeader(HeaderName.ACCESS_CONTROL_ALLOW_HEADERS, "*");
		response.setHeader(HeaderName.ACCESS_CONTROL_ALLOW_ORIGIN, "*");
		response.setHeader(HeaderName.ACCESS_CONTROL_REQUEST_METHOD, "*");
	}
